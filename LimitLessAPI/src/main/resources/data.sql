-- Role records
INSERT INTO `limitless`.`role` (`role_id`, `name`) VALUES (UUID_TO_BIN('df3e919d-13cd-11ee-994a-0ef6d89b856b'), 'US');
INSERT INTO `limitless`.`role` (`role_id`, `name`) VALUES (UUID_TO_BIN('d6f6a137-13cd-11ee-994a-0ef6d89b856b'), 'AD');



-- User records
INSERT INTO `limitless`.`users` (`user_id`, `role_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `level`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('7ebf33ee-13cf-11ee-994a-0ef6d89b856b'), UUID_TO_BIN('d6f6a137-13cd-11ee-994a-0ef6d89b856b'), '20', '2002-06-24', 'admin@gmail.com', 'Admin', '0', '170', 'Beginner', '$2a$12$CFlbkyA9ZIwM7FJMDX65heGB/5MUg3JOWtcmUYLjD1zWar9WFOS06', '0901234567', '2', 'admin', '60');
INSERT INTO `limitless`.`users` (`user_id`, `role_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `level`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e7960aa-f7dd-11ed-bcc5-a85e45c41921'), UUID_TO_BIN('df3e919d-13cd-11ee-994a-0ef6d89b856b'), '20', '2002-06-24', 'luugiavinh@gmail.com', 'Luu Gia Vinh', '0', '170', 'Beginner', '$2a$12$l1CSdOoXhSEPrT98j9Xj.ejDg9EdyweFuBKwnbEK4U72ZVWY4UoLO', '0903647536', '2', 'luugiavinh', '60');
INSERT INTO `limitless`.`users` (`user_id`, `role_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `level`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e797140-f7dd-11ed-bcc5-a85e45c41921'), UUID_TO_BIN('df3e919d-13cd-11ee-994a-0ef6d89b856b'), '20', '2002-03-15', 'nguyentrunghieu@gmail.com', 'Nguyen Trung Hieu', '0', '170', 'Beginner', '$2a$12$B7KedHg8Nr0uzVW3HSJ93uHNQBQ2qKvfH4X.4u4hAPN5kl.309qEG', '0908574625', '2', 'nguyentrunghieu', '60');
INSERT INTO `limitless`.`users` (`user_id`, `role_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `level`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e797fdf-f7dd-11ed-bcc5-a85e45c41921'), UUID_TO_BIN('df3e919d-13cd-11ee-994a-0ef6d89b856b'), '20', '2002-04-25', 'phamhongquang@gmail.com', 'Pham Hong Quang', '0', '170', 'Intermediate', '$2a$12$88DDmVQOdlrxfBdLq3NR1eNCdin19Emt852uS17GleE2zcBi6v7kC', '0903645231', '2', 'phamhongquang', '60');
INSERT INTO `limitless`.`users` (`user_id`, `role_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `level`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e79ac7f-f7dd-11ed-bcc5-a85e45c41921'), UUID_TO_BIN('df3e919d-13cd-11ee-994a-0ef6d89b856b'), '20', '2002-03-13', 'danghoanganhkhoa@gmail.com', 'Dang Hoang Anh Khoa', '0', '170', 'Advanced', '$2a$12$o3AAWSFAiDuA4i6JWJa//.yH4UIWty8VqcZppOEbYEI4R1vs.modG', '0905757463', '2', 'danghoanganhkhoa', '60');
INSERT INTO `limitless`.`users` (`user_id`, `role_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `level`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e79b77b-f7dd-11ed-bcc5-a85e45c41921'), UUID_TO_BIN('df3e919d-13cd-11ee-994a-0ef6d89b856b'), '20', '2002-07-21', 'dangnguyenhiep@gmail.com', 'Dang Nguyen Hiep', '0', '170', 'Intermediate', '$2a$12$.F5FMOgYQA3e4E3YmkE8yeYw0dNVgSAgIdsx.V8oH6Z.QGYi7VuiC', '0907878342', '2', 'dangnguyenhiep', '60');
INSERT INTO `limitless`.`users` (`user_id`, `role_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `level`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e79c727-f7dd-11ed-bcc5-a85e45c41921'), UUID_TO_BIN('df3e919d-13cd-11ee-994a-0ef6d89b856b'), '20', '2002-07-27', 'nguyendaiduong@gmail.com', 'Nguyen Dai Duong', '0', '170', 'Advanced','$2a$12$xiVnWoKE5hw1nc9CHUuMd.JsdxSe.REp.8T7UinSyiKdzM2pvJJdW', '0904635263', '2', 'nguyendaiduong', '60');

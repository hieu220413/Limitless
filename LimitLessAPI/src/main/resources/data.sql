-- User records
INSERT INTO `limitless`.`users` (`user_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e7960aa-f7dd-11ed-bcc5-a85e45c41921'),'20', '2002-06-24', 'luugiavinh@gmail.com', 'Luu Gia Vinh', '0', '170', '$2a$12$l1CSdOoXhSEPrT98j9Xj.ejDg9EdyweFuBKwnbEK4U72ZVWY4UoLO', '0903647536', '0', 'luugiavinh', '60');
INSERT INTO `limitless`.`users` (`user_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e797140-f7dd-11ed-bcc5-a85e45c41921'),'20', '2002-03-15', 'nguyentrunghieu@gmail.com', 'Nguyen Trung Hieu', '0', '170', '$2a$12$B7KedHg8Nr0uzVW3HSJ93uHNQBQ2qKvfH4X.4u4hAPN5kl.309qEG', '0908574625', '0', 'nguyentrunghieu', '60');
INSERT INTO `limitless`.`users` (`user_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e797fdf-f7dd-11ed-bcc5-a85e45c41921'),'20', '2002-04-25', 'phamhongquang@gmail.com', 'Pham Hong Quang', '0', '170', '$2a$12$88DDmVQOdlrxfBdLq3NR1eNCdin19Emt852uS17GleE2zcBi6v7kC', '0903645231', '0', 'phamhongquang', '60');
INSERT INTO `limitless`.`users` (`user_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e79ac7f-f7dd-11ed-bcc5-a85e45c41921'),'20', '2002-03-13', 'danghoanganhkhoa@gmail.com', 'Dang Hoang Anh Khoa', '0', '170', '$2a$12$o3AAWSFAiDuA4i6JWJa//.yH4UIWty8VqcZppOEbYEI4R1vs.modG', '0905757463', '0', 'danghoanganhkhoa', '60');
INSERT INTO `limitless`.`users` (`user_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e79b77b-f7dd-11ed-bcc5-a85e45c41921'),'20', '2002-07-21', 'dangnguyenhiep@gmail.com', 'Dang Nguyen Hiep', '0', '170', '$2a$12$.F5FMOgYQA3e4E3YmkE8yeYw0dNVgSAgIdsx.V8oH6Z.QGYi7VuiC', '0907878342', '0', 'dangnguyenhiep', '60');
INSERT INTO `limitless`.`users` (`user_id`, `age`, `dob`, `email`, `full_name`, `gender`, `height`, `password`, `phone`, `status`, `username`, `weight`) VALUES (UUID_TO_BIN('4e79c727-f7dd-11ed-bcc5-a85e45c41921'),'20', '2002-07-27', 'nguyendaiduong@gmail.com', 'Nguyen Dai Duong', '0', '170', '$2a$12$xiVnWoKE5hw1nc9CHUuMd.JsdxSe.REp.8T7UinSyiKdzM2pvJJdW', '0904635263', '0', 'nguyendaiduong', '60');
...
-- workout records
INSERT INTO `limitless`.`workout` (`workout_id`, `description`, `name`, `status`, `thumbnail`, `total_exercise`, `level_id`) VALUES (UUID_TO_BIN('c186c33d-f7ec-11ed-bcc5-a85e45c41921'), 'change later', 'workout1', '0', 'thumbnail', '4', UUID_TO_BIN('fd76ced1-f7de-11ed-bcc5-a85e45c41921'));
INSERT INTO `limitless`.`workout` (`workout_id`, `description`, `name`, `status`, `thumbnail`, `total_exercise`, `level_id`) VALUES (UUID_TO_BIN('c186e4db-f7ec-11ed-bcc5-a85e45c41921'), 'change later', 'workout2', '0', 'thumbnail', '5', UUID_TO_BIN('fd76ced1-f7de-11ed-bcc5-a85e45c41921'));
INSERT INTO `limitless`.`workout` (`workout_id`, `description`, `name`, `status`, `thumbnail`, `total_exercise`, `level_id`) VALUES (UUID_TO_BIN('c186fdaf-f7ec-11ed-bcc5-a85e45c41921'), 'change later', 'workout3', '0', 'thumbnail', '3', UUID_TO_BIN('fd76b59a-f7de-11ed-bcc5-a85e45c41921'));
INSERT INTO `limitless`.`workout` (`workout_id`, `description`, `name`, `status`, `thumbnail`, `total_exercise`, `level_id`) VALUES (UUID_TO_BIN('c1870d98-f7ec-11ed-bcc5-a85e45c41921'), 'change later', 'workout4', '0', 'thumbnail', '5', UUID_TO_BIN('fd770718-f7de-11ed-bcc5-a85e45c41921'));
